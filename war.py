...
class Card:
    ...
    def __init__(self, num):
        ...
        if num < 13:
            ...
            suit = "Spades"
        self.photo = PhotoImage(file = name + " " + suit + ".png")
...
CardBack = PhotoImage(file="Card Back.png")
# Resize image
CardBack = CardBack.subsample(4,4) 
...
PlayerCard = ttk.Label(frame2, image = CardBack).grid(row = 1,column = 1, sticky = (N, W, E, S))
